	...
	<div class="left main-sidebar">
		...
		<div class="sidebar-inner leftscroll">
			...
			<ul>
                    ...
                    <li class="submenu">
                        <a href="#"><span class="label radius-circle bg-danger float-right">!!</span><i class="fa fa-fw fa-copy"></i><span> Example Pages </span></a>
                            <ul class="list-unstyled">								
					...
					<li class="submenu">
                        <a href="#"><span class="label radius-circle bg-danger float-right">!!</span><i class="fa fa-fw fa-indent"></i><span> Menu Levels </span></a>
                            <ul>
								<li>
