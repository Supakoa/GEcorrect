	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="loca">แก้ไข
					<?php echo $r['std_id'];?>
				</h5>
					...
					<div class="form-group">
						<div class="row">
							<div class="col-md-7">
								...
								<input name="edit_id" form="form_3" id="id" class="form-control" type="text" value="<?php echo $r['std_id']; ?>"
								 required>
							</div>
							<div class="col-md-6">
								<label for="fname">ชื่อ-นามสกุล</label>
								<input name="edit_name" form="form_3" id="fname" class="form-control" type="text" value="<?php echo $r['name']; ?>"
								 required>
							</div>
						</div>
					</div>
